...
<div class="flex flex-col gap-2">
	<div class="grid grid-cols-2 gap-2">
		<label class={wrapCls}>
			<span class={labelCls}>First</span>
			<input
				class={inputCls}
				type="text"
				aria-label="vCard first name"
				value={qrState.payloads.vcard.firstName}
				oninput={(e) => qrState.setPayloadField('vcard', 'firstName', e.currentTarget.value)}
			/>
		</label>
		<label class={wrapCls}>
			<span class={labelCls}>Last</span>
			<input
				class={inputCls}
				type="text"
				aria-label="vCard last name"
				value={qrState.payloads.vcard.lastName}
				oninput={(e) => qrState.setPayloadField('vcard', 'lastName', e.currentTarget.value)}
			/>
		</label>
	</div>
	<label class={wrapCls}>
		...
		<input
			...
			oninput={(e) => qrState.setPayloadField('vcard', 'phone', e.currentTarget.value)}
		/>
	</label>
	<label class={wrapCls}>
		...
		<input
			...
			oninput={(e) => qrState.setPayloadField('vcard', 'email', e.currentTarget.value)}
		/>
	</label>
	<label class={wrapCls}>
		<span class={labelCls}>Org</span>
		<input
			class={inputCls}
			type="text"
	...
	<label class={wrapCls}>
		...
		<input
			...
			oninput={(e) => qrState.setPayloadField('vcard', 'title', e.currentTarget.value)}
		/>
	</label>
	<label class={wrapCls}>
		<span class={labelCls}>URL</span>
		<input
			class={inputCls}
			type="url"
	...
	<label class={wrapCls}>
		...
		<input
			...
			oninput={(e) => qrState.setPayloadField('vcard', 'address', e.currentTarget.value)}
		/>
	</label>
</div>
