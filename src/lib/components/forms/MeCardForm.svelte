...
<div class="flex flex-col gap-2">
	<label class={wrapCls}>
		...
		<input
			...
			oninput={(e) => qrState.setPayloadField('mecard', 'name', e.currentTarget.value)}
		/>
	</label>
	<label class={wrapCls}>
		...
		<input
			...
			oninput={(e) => qrState.setPayloadField('mecard', 'phone', e.currentTarget.value)}
		/>
	</label>
	<label class={wrapCls}>
		...
		<input
			...
			oninput={(e) => qrState.setPayloadField('mecard', 'email', e.currentTarget.value)}
		/>
	</label>
	<label class={wrapCls}>
	...
	<label class={wrapCls}>
		...
		<input
			...
			oninput={(e) => qrState.setPayloadField('mecard', 'address', e.currentTarget.value)}
		/>
	</label>
	<label class={wrapCls}>
		<span class={labelCls}>Note</span>
		<textarea
			class="{inputCls} min-h-[60px] resize-y"
			aria-label="MeCard note"
			rows="2"
			value={qrState.payloads.mecard.note}
			oninput={(e) => qrState.setPayloadField('mecard', 'note', e.currentTarget.value)}
		></textarea>
	</label>
</div>
